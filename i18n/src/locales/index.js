...
import es from './es' // importa o objeto de traduções para o idioma português
...
const getLanguage = (language) => {
  ...
  if (normalizeTranslate[language]) {
    return normalizeTranslate[language]
  }
  if (language.includes("_"))
    if (normalizeTranslate[language.split('_')[0]])
      return normalizeTranslate[language.split('_')[0]]
...
const setLanguageToI18n = () => {
  ...
  const translateNormalize = getLanguage(language)
  I18n.locale = translateNormalize// translateNormalize
